...
def The_Cat():                  #On commence la définition de la fonction qui dessine "The_Cat"             
    ...
    right(90)
    circle((1/3)*(metric*1.5),90)    #Deumetricième oreille
    left(90)
    fd(metric*1.3)    
...
def The_perroquet():             #On commence la définition de la fonction qui dessine "The_perroquet"
    ...
    fd((metric2)*2)
    setheading(180)
    fillcolor("white")          #On change la couleur de remplissage en blanc pour les yeumetric
    begin_fill()
...
def The_Snake():                #On commence la définition de la fonction qui dessine "The_Snake"
    ...
    for i in range(2):          #On fait une boucle pour dessiner les deumetric serpents (gauche et droite)
        ...
        end_fill()
        setheading(90)
        fd((metric)*(6/10))          #On avance pour se placer au bon endroit pour dessiner les yeumetric
        fillcolor("white")
        """Dans cette partie on dessine les yeumetric du serpent"""
        begin_fill()
        ...
        sens_cercle2=-sens_cercle2                  #On inverse le signe de sens_cercle2 pour que les yeumetric(=cercle) soient dessinés dans l'autre sens(antihoraire/horraire)
